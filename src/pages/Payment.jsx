  ...
  return (
    <div className="payment-container">
      ...
      <div className="payment-inner-container">
        ...
        <div className="payment-summary-section">
          ...
          <div className="payment-summary-card">
            <img src="/images/pop car2.png" alt="Car" className="payment-car-img" />
            <div>
          ...
          <div className="payment-form-section">
            ...
            <div className="payment-input-grid">
              <div className="payment-input-group">
                <label className="payment-label" htmlFor="name">Your Name</label>
                <input type="text" id="name" placeholder="Your name" className="payment-input2" />
              </div>

              <div className="payment-input-group">
                <label className="payment-label" htmlFor="phone">Phone Number</label>
                <input type="text" id="phone" placeholder="Phone number" className="payment-input2" />
              </div>

              <div className="payment-input-group">
                <label className="payment-label" htmlFor="address">Address</label>
                <input type="text" id="address" placeholder="Address" className="payment-input2" />
              </div>

              <div className="payment-input-group">
                <label className="payment-label" htmlFor="town">Town or City</label>
                <input type="text" id="town" placeholder="Town or city" className="payment-input2" />
              </div>
            </div>
            ...
            <div className="payment-info-block">
              ...
              <p className="subtext-rental-date">Please select your rental date</p>
      ...
      <div className="payment-visa-container">
        ...
        <p className="payment-payment-subtext">Please enter your payment method</p>

        <div className="payment-payment-options">
          <label className="payment-payment-option">
            <input className="payment-credite-ratio"
              type="radio"
              name="payment"
              value="credit"
            ...
            <div className="payment-credit-img">
              <img src="https://upload.wikimedia.org/wikipedia/commons/4/41/Visa_Logo.png" alt="Visa" className="payment-logo3" />
            ...
            <div className="payment-credit-form">
              ...
              <div className="payment-input-row">
                <div>
                  ...
                  <label className="payment-label-card" htmlFor="cardNumber">Card Number</label>
                  <input type="text" id="cardNumber" placeholder="Card number" />
                </div>

                <div>

                  <label className="payment-label-card" htmlFor="expiryDate">Expiry Date</label>
              ...
              <div className="payment-input-row1">
                <div>
                  <label className="payment-label-card" htmlFor="cardHolder">Card Holder</label>
                  <input type="text" id="cardHolder" placeholder="Card holder" />
                </div>

                <div>
                  <label className="payment-label-card" htmlFor="cvc">CVC</label>
          ...
          <label className="payment-payment-option">
            ...
            />
            <span>PayPal</span>
            <img src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" alt="PayPal" className="payment-logo-large" />
          </label>
...
<div className="confirm-container">
  ...
  <p className="confirm-subhed">We are getting to the end. Just few clicks and your rental is ready!</p>

  <div className="confirm-checkbox-group">
    <label className="confirm-checkbox-item">
      <input className="confirm-checkbox"     
        type="checkbox"
